...
사용자가 제공한 레퍼런스 쇼츠와 짧은 주제 정보를 바탕으로 약 60초짜리 쇼츠용 대본과 장면 목록을 작성한다. 결과물은 이후 미디어 검색, TTS, 자막, 영상 합성 단계가 바로 사용할 수 있는 구조화된 JSON이어야 한다.

## 입력

```text
레퍼런스 쇼츠: 링크 또는 파일 3~5개
주제: ...
반드시 포함할 정보: ...
피하고 싶은 방향: ...
```
...
1. 레퍼런스의 형식과 리듬만 추출하고, 문장·장면·이미지를 복제하지 않는다.
...
```json
{
  ...
  "reference_style": "shorts-style-profile",
